...
const std::vector<Metric> Metrics::m_metrics = {
    ...
    Metric(   V2         ,  19,      "engine[1].manifold_pressure", Metric::ScaleFactor::TEN),
    Metric(V1|V2|V3|V4|V5,  20,      "voltage[0]", Metric::ScaleFactor::TEN),
    Metric(V1|V2|V3|V4|V5,  21,      "outside_air_temperature"),
    Metric(V1|V2|V3|V4|V5,  22,      "engine[0].fuel_used[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(V1|V2|V3|V4|V5,  23,      "engine[0].fuel_flow[0]", Metric::ScaleFactor::TEN_IF_GPH),
    ...
    // byte 5
    Metric(V1|V2|V3|V4|V5,  40,      "engine[0].manifold_pressure", Metric::ScaleFactor::TEN),
    ...
    Metric(   V2      |V5,  46,      "engine[1].fuel_used[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(         V4   ,  46,      "engine[0].fuel_flow[1]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(         V4   ,  47,      "engine[0].fuel_used[1]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(   V2      |V5,  47,      "engine[1].fuel_flow[0]", Metric::ScaleFactor::TEN_IF_GPH),

    // byte 8
    Metric(      V3|V4|V5,  64,      "amperage[0]"),
    Metric(      V3|V4|V5,  65,      "voltage[1]", Metric::ScaleFactor::TEN),
    Metric(      V3|V4|V5,  66,      "amperage[1]"),
    Metric(      V3|V4   ,  67,      "engine[1].fuel_level[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(            V5,  67,      "engine[0].fuel_level[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(      V3|V4   ,  68,      "engine[0].fuel_level[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(            V5,  68,      "engine[0].fuel_level[1]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(      V3|V4|V5,  69,      "engine[0].fuel_pressure", Metric::ScaleFactor::TEN),
    Metric(            V5,  70,      "engine[0].horsepower"),
    Metric(         V4   ,  71,      UNSUPPORTED_METRIC, Metric::ScaleFactor::TEN_IF_GPH),  // left aux level ?
    Metric(            V5,  71,      "engine[0].fuel_level[2]", Metric::ScaleFactor::TEN_IF_GPH),
    ...
    Metric(         V4|V5,  78,  79, "engine[0].hours", Metric::ScaleFactor::TEN),

    // byte 10
    Metric(         V4   ,  84,      UNSUPPORTED_METRIC, Metric::ScaleFactor::TEN_IF_GPH),  // right aux level ?

    // byte 11
    Metric(            V5,  88,      "engine[1].manifold_pressure", Metric::ScaleFactor::TEN),
    Metric(            V5,  89,      "engine[1].horsepower"),
    Metric(            V5,  90,      "engine[1].induction_air_temperature"),
    Metric(            V5,  91,      "engine[1].fuel_level[0]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(            V5,  92,      "engine[1].fuel_level[1]", Metric::ScaleFactor::TEN_IF_GPH),
    Metric(            V5,  93,      "engine[1].fuel_pressure", Metric::ScaleFactor::TEN),
    Metric(            V5,  94,      "engine[1].oil_pressure", Metric::ScaleFactor::TEN),
    Metric(            V5,  95,      "engine[1].fuel_level[2]", Metric::ScaleFactor::TEN_IF_GPH),
    ...
    Metric(            V5, 102, 103, "engine[1].hours", Metric::ScaleFactor::TEN),
    ...
    Metric(            V5, 107,      "engine[1].fuel_flow[1]", Metric::ScaleFactor::TEN_IF_GPH),
    ...
    Metric(            V5, 114, 118, "engine[1].exhaust_gas_temperature[6]"),
    Metric(            V5, 115,      "engine[1].fuel_flow[1]", Metric::ScaleFactor::TEN_IF_GPH),
