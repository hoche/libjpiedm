...
const std::vector<Metric> Metrics::m_metrics = {
    ...
    Metric(         V4|V5,  86,      IDSTR(LNG), "longitude", Metric::ScaleFactor::NONE, Metric::InitialValue::ZERO),
    Metric(         V4|V5,  87,      IDSTR(LAT), "latitude", Metric::ScaleFactor::NONE, Metric::InitialValue::ZERO),
